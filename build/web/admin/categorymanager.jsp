                                    ...
                                    <div class="sliderList">
                                        <div class="input-group" style="margin-bottom: 10px;width: 100%; ">
                                                <div class="left-filter">
                                                    <a class="btn btn-primary" href="CategoryManager?service=add">Add Category</a>
                                                </div>
                                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach var="s" items="${cates}">
                                                    <tr>
                                                        ...
                                                        <td>${s.getName()}</td>
                                                        <td><a class="btn btn-primary" href="CategoryManager?service=edit&cid=${s.getId()}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                                        <td><a class="btn btn-danger" href="CategoryManager?service=del&cid=${s.getId()}"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                                    </tr>
                                                    <!-- Show detail modal -->
                                            </c:forEach>
                                            </tbody>
